...
CallbackReturn FRIHardwareInterface::on_init(const hardware_interface::HardwareInfo& info) {
...
CallbackReturn FRIHardwareInterface::on_activate() {
    app_.connect(hw_port_, hw_remote_host_);    
    return CallbackReturn::SUCCESS;
}

CallbackReturn FRIHardwareInterface::on_activate(const rclcpp_lifecycle::State & previous_state) {
    app_.connect(hw_port_, hw_remote_host_);    
    return CallbackReturn::SUCCESS;
}

CallbackReturn FRIHardwareInterface::on_deactivate() {
...
CallbackReturn FRIHardwareInterface::on_deactivate(const rclcpp_lifecycle::State & previous_state) {
    RCLCPP_INFO(rclcpp::get_logger(FRI_HW_LOGGER), "Disconnecting FRI...");
    app_.disconnect();
    RCLCPP_INFO(rclcpp::get_logger(FRI_HW_LOGGER), "Done.");
